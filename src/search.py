...
def main():
    ...
    parser.add_argument('-p', '--provider', default='bing',
    ...
    parser.add_argument('-n', '--nanswers', default=1, type=int,
            help='returns the top n answers (must be less than the cutoff value), defaults to 1')
    args = parser.parse_args()

    q, k, p, c, n = args.query, args.key, args.provider, args.cutoff, args.nanswers
